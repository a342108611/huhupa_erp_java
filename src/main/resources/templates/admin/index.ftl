                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">呼呼啪</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                        <div class="logo-element">呼呼啪
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                         ...
                         <@shiro.hasPermission name="system:resource:index">
                            ...
                            <li>
                                <a class="J_menuItem" href="${ctx!}/admin/user/session">会话管理</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${ctx!}/business/attendance/fillAttendance">填报考勤</a>
                            </li>
                        </ul>
                    </li>
                    <li class="line dk"></li>
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                                <i class="fa fa-user"></i> <span class="label label-primary"></span>【<@shiro.principal type="com.huhupa.base.entity.User" property="nickName"/>】
                            </a>
                                ...
                                <li>
                                    <a onclick="updatePwd()">
                                        <div>
                                            ...
                                            <span class="pull-right text-muted small"><@shiro.principal type="com.huhupa.base.entity.User" property="nickName"/></span>
                                        </div>
                                    </a>
                                </li>
                                <li>
