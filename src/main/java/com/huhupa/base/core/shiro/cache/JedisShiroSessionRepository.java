package com.huhupa.base.core.shiro.cache;

import com.huhupa.base.common.utils.LoggerUtils;
import com.huhupa.base.common.utils.SerializeUtil;
import com.huhupa.base.core.shiro.session.CustomSessionManager;
import com.huhupa.base.core.shiro.session.SessionStatus;
...
public class JedisShiroSessionRepository implements ShiroSessionRepository {
    ...
    public void saveSession(Session session) {
        ...
        try {
            String s = buildRedisSessionKey(session.getId());
            System.out.println("buildRedisSessionKey.getId():" + s);
            ...
            if(null == session.getAttribute(CustomSessionManager.SESSION_STATUS)){
            	...
            	System.out.println("保存成功：" + sessionStatus);
             ...
             */
            System.out.println("DB_INDEX:" + DB_INDEX);
            System.out.println("key:" + key);
            System.out.println("value:" + value);
            System.out.println("(int) (session.getTimeout() / 1000):" + (int) (session.getTimeout() / 1000));
